	...
	return (
		<div className={`${styles.pokemon} ${pokemonType}-bg`}>
			...
			<div className={styles.pokemon__info}>
				...
				<h2 className={`${pokemonType}-text`}>About</h2>
				...
				{pokemon.stats.map((stat, index) => (
					<div key={index} className={styles.pokemon__stat}>
						...
						<div className={styles.pokemon__stat__number}>
							<div className={styles.number}>{stat.base_stat}</div>
							<div className={styles.bar}>
								<div className={`${styles.stat} ${pokemonType}-bg`} style={{ width: stat.base_stat / 1.5 + '%'}}></div>
							</div>					
						</div>
					</div>
				))}				
